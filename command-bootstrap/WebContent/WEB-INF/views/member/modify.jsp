	...
	<div>
			...
			<form role="form" class="form-horizontal" action="modify.do"
				...
				<div class="register-box" style="min-width: 450px;">
					<div class="register-card-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input readonly name="id" type="text" class="form-control"
									id="id" placeholder="13글자 영문자,숫자 조합" value="${member.id }">
							</div>
						</div>
						...
						<div class="form-group row">
							<label for="pwd" class="col-sm-3 control-label text-center">이
								름</label>
							...
							<div class="col-sm-9">
								<select name="authority" class="form-control">
									<option value="ROLE_USER"
										${member.authority eq 'ROLE_USER' ? 'selected' : ''}>사용자</option>
									<option value="ROLE_MANAGER"
										${member.authority eq 'ROLE_MANAGER' ? 'selected' : ''}>운영자</option>
									<option value="ROLE_ADMIN"
										${member.authority eq 'ROLE_ADMIN' ? 'selected' : ''}>관리자</option>
								</select>
							</div>
						</div>
						<div class="form-group row">
		...
		<script>
			...
			function changePicture_go() {
				var picture = $('input#inputFile')[0]; // ♣ 이거 인덱스 왜줌?
